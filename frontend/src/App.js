...
function App() {
  ...
  {devInfo.metadata.repo_html_url && (
    <>
      ...
      <div className="link-item">
        <a
          href={`${devInfo.metadata.repo_html_url}/issues`}
          target="_blank"
          rel="noreferrer"
        >
          🗂 All Issues
      ...
      {/* Developer loading card (if they click while it's fetching) */}
      {devLoading && (
        <section className="card fade-in">
